...
# the input.gyro maybe changed in the following exculation therefore the backup of the input.gyro is important which will help us to know the original setup
...
# add some paramter accompanied with ky, choose when L_M3scan3.py is used
        if root['SETTINGS']['SETUP'].has_key('iscan_3') and root['SETTINGS']['SETUP']['iscan_3']==1: 
